	...
	<div id="wrapper">
		...
		<?php
			...
			<form method="post" action="cart.php">  
                            <div class="item">
                               <img src="<?php echo $row["image"]; ?>" class="sale" /><br />  
...
?>  
		...
		<div class="item">
		<img src="Photos/Men/tees/tee2.jpg" class="sale"/>
		<p><b>Moon Rocket</b><br>
			Online Exclusive<br>
			$35<br>
			<button onclick="addToBag()" class="add-bag">Add to Bag </button></p>
		</div>
		<div class="item">
		<img src="Photos/Men/tees/tee3.jpg" class="sale"/>
		<p><b>Valley Motor</b><br>
			Online Exclusive<br>
			$35<br>
			<button onclick="addToBag()" class="add-bag">Add to Bag </button></p>
		</div>
		<div class="item">
		<img src="Photos/Men/tees/tee4.jpg" class="sale"/>
		<p><b>55 Chew</b><br>
			Online Exclusive<br>
			$35<br>
			<button onclick="addToBag()" class="add-bag">Add to Bag </button></p>
		...
		<div class="item">
		<img src="Photos/Men/tees/tee5.jpg" class="sale"/>
		<p><b>Love Bite</b><br>
			Online Exclusive<br>
			$35<br>
			<button onclick="addToBag()" class="add-bag">Add to Bag </button></p>
		...
		<div class="item">
		<img src="Photos/Men/tees/tee6.jpg" class="sale"/>
		<p><b>Doggy</b><br>
			Online Exclusive<br>
			$35<br>
			<button onclick="addToBag()" class="add-bag">Add to Bag </button></p>
		...
		<div class="item">
		<img src="Photos/Men/tees/tee7.jpg" class="sale"/>
		<p><b>Capital</b><br>
			Online Exclusive<br>
			$35<br>
			<button onclick="addToBag()" class="add-bag">Add to Bag </button></p>
		...
		<div class="item">
		<img src="Photos/Men/tees/tee8.jpg" class="sale"/>
		<p><b>Heart</b><br>
			Online Exclusive<br>
			$35<br>
			<button onclick="addToBag()" class="add-bag">Add to Bag </button></p>
		...
		<div class="item">
		<img src="Photos/Men/tees/tee9.jpg" class="sale"/>
		<p><b>Rooster</b><br>
			Online Exclusive<br>
			$35<br>
			<button onclick="addToBag()" class="add-bag">Add to Bag </button></p>
		...
		<div class="item">
		<img src="Photos/Men/tees/tee10.png" class="sale"/>
		<p><b>Lucky Dog</b><br>
			Online Exclusive<br>
			$35<br>
			<button onclick="addToBag()" class="add-bag">Add to Bag </button></p>
		...
		<div class="item">
		<img src="Photos/Men/tees/tee11.jpg" class="sale"/>
		<p><b>Big Evil</b><br>
			Online Exclusive<br>
			$35<br>
			<button onclick="addToBag()" class="add-bag">Add to Bag </button></p>
		...
		<div class="item">
		<img src="Photos/Men/tees/tee12.jpg" class="sale"/>
		<p><b>C Style</b><br>
			Online Exclusive<br>
			$35<br>
			<button onclick="addToBag()" class="add-bag">Add to Bag </button></p>
