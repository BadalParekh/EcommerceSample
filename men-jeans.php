...
<body onload="startTimer()">
	<div id="wrapper">
		...
		<h2> Men's Jeans</h2>
		<div class="item">
		<img src="Photos/Men/jeans/jean1.jpg" class="sale"/>
		<p><b>Classic Red</b><br>
			Online Exclusive<br>
			$20<br>
			<button onclick="addToBag()" class="add-bag">Add to Bag </button></p>
		</div>
		<div class="item">
		<img src="Photos/Men/jeans/jean2.jpg" class="sale"/>
		<p><b>Skinny Vintage</b><br>
			Online Exclusive<br>
			$20<br>
			<button onclick="addToBag()" class="add-bag">Add to Bag </button></p>
		</div>
		<div class="item">
		<img src="Photos/Men/jeans/jean3.jpg" class="sale"/>
		<p><b>YE Jean</b><br>
			Online Exclusive<br>
			$20<br>
			<button onclick="addToBag()" class="add-bag">Add to Bag </button></p>
		...
		<div class="item">
		<img src="Photos/Men/jeans/jean4.jpg" class="sale"/>
		<p><b>MUD Jean</b><br>
			Online Exclusive<br>
			$20<br>
			<button onclick="addToBag()" class="add-bag">Add to Bag </button></p>
		...
		<div class="item">
		<img src="Photos/Men/jeans/jean5.jpg" class="sale"/>
		<p><b>20s Dream</b><br>
			Online Exclusive<br>
			$20<br>
			<button onclick="addToBag()" class="add-bag">Add to Bag </button></p>
		...
		<div class="item">
		<img src="Photos/Men/jeans/jean6.jpg" class="sale"/>
		<p><b>Futuristic</b><br>
			Online Exclusive<br>
			$20<br>
			<button onclick="addToBag()" class="add-bag">Add to Bag </button></p>
		...
		<div class="item">
		<img src="Photos/Men/jeans/jean7.jpg" class="sale"/>
		<p><b>Capital</b><br>
			Online Exclusive<br>
			$20<br>
			<button onclick="addToBag()" class="add-bag">Add to Bag </button></p>
		...
		<div class="item">
		<img src="Photos/Men/jeans/jean8.jpg" class="sale"/>
		<p><b>USA</b><br>
			Online Exclusive<br>
			$20<br>
			<button onclick="addToBag()" class="add-bag">Add to Bag </button></p>
		...
		<div class="item">
		<img src="Photos/Men/jeans/jean9.jpg" class="sale"/>
		<p><b>KAMAIN-J</b><br>
			Online Exclusive<br>
			$20<br>
			<button onclick="addToBag()" class="add-bag">Add to Bag </button></p>
		...
		<div class="item">
		<img src="Photos/Men/jeans/jean10.jpg" class="sale"/>
		<p><b>Montana Morning</b><br>
			Online Exclusive<br>
			$20<br>
			<button onclick="addToBag()" class="add-bag">Add to Bag </button></p>
		</div>
		<div class="item">
		<img src="Photos/Men/jeans/jean11.jpg" class="sale"/>
		<p><b>Big Evil</b><br>
			Online Exclusive<br>
			$20<br>
			<button onclick="addToBag()" class="add-bag">Add to Bag </button></p>
		...
		<div class="item">
		<img src="Photos/Men/jeans/jean12.jpg" class="sale"/>
		<p><b>VSCT</b><br>
			Online Exclusive<br>
			$20<br>
			<button onclick="addToBag()" class="add-bag">Add to Bag </button></p>
