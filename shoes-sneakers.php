...
<body onload="startTimer()">
	<div id="wrapper">
		...
		<h2> Sneakers</h2>
		<div class="item">
		<img src="Photos/Shoes/sneakers/sneaker1.jpg" class="sale"/>
		<p><b>Apple Vintage</b><br>
			Online Exclusive<br>
			$40<br>
			<button onclick="addToBag()" class="add-bag">Add to Bag </button></p>
		</div>
		<div class="item">
		<img src="Photos/Shoes/sneakers/sneaker2.jpg" class="sale"/>
		<p><b>Nike Vintage</b><br>
			Online Exclusive<br>
			$40<br>
			<button onclick="addToBag()" class="add-bag">Add to Bag </button></p>
		</div>
		<div class="item">
		<img src="Photos/Shoes/sneakers/sneaker3.jpg" class="sale"/>
		<p><b>All Star</b><br>
			Online Exclusive<br>
			$40<br>
			<button onclick="addToBag()" class="add-bag">Add to Bag </button></p>
		...
		<div class="item">
		<img src="Photos/Shoes/sneakers/sneaker4.jpeg" class="sale"/>
		<p><b>Military Vintage</b><br>
			Online Exclusive<br>
			$40<br>
			<button onclick="addToBag()" class="add-bag">Add to Bag </button></p>
		</div>
		<div class="item">
		<img src="Photos/Shoes/sneakers/sneaker5.jpg" class="sale"/>
		<p><b>Puma Vintage</b><br>
			Online Exclusive<br>
			$40<br>
			<button onclick="addToBag()" class="add-bag">Add to Bag </button></p>
		</div>
		<div class="item">
		<img src="Photos/Shoes/sneakers/sneaker6.jpeg" class="sale"/>
		<p><b>Simple Brown</b><br>
			Online Exclusive<br>
			$40<br>
			<button onclick="addToBag()" class="add-bag">Add to Bag </button></p>
		</div>
		<div class="item">
		<img src="Photos/Shoes/sneakers/sneaker7.jpg" class="sale"/>
		<p><b>Capital</b><br>
			Online Exclusive<br>
			$40<br>
			<button onclick="addToBag()" class="add-bag">Add to Bag </button></p>
		...
		<div class="item">
		<img src="Photos/Shoes/sneakers/sneaker8.jpg" class="sale"/>
		<p><b>Peace US</b><br>
			Online Exclusive<br>
			$40<br>
			<button onclick="addToBag()" class="add-bag">Add to Bag </button></p>
		...
		<div class="item">
		<img src="Photos/Shoes/sneakers/sneaker9.jpg" class="sale"/>
		<p><b>Adidas Clean</b><br>
			Online Exclusive<br>
			$40<br>
			<button onclick="addToBag()" class="add-bag">Add to Bag </button></p>
		</div>
		<div class="item">
		<img src="Photos/Shoes/sneakers/sneaker10.jpg" class="sale"/>
		<p><b>New Balance Vintage</b><br>
			Online Exclusive<br>
			$40<br>
			<button onclick="addToBag()" class="add-bag">Add to Bag </button></p>
		</div>
		<div class="item">
		<img src="Photos/Shoes/sneakers/sneaker11.jpeg" class="sale"/>
		<p><b>Nike Vintage</b><br>
			Online Exclusive<br>
			$40<br>
			<button onclick="addToBag()" class="add-bag">Add to Bag </button></p>
		...
		<div class="item">
		<img src="Photos/Shoes/sneakers/sneaker12.jpg" class="sale"/>
		<p><b>Puma Mirage</b><br>
			Online Exclusive<br>
			$40<br>
			<button onclick="addToBag()" class="add-bag">Add to Bag </button></p>
		</div>
