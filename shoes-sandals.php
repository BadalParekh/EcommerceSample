...
<body onload="startTimer()">
	<div id="wrapper">
		...
		<h2> Sandals</h2>
		<div class="item">
		<img src="Photos/Shoes/sandals/sandal1.jpg" class="sale"/>
		<p><b>Brown Vintage</b><br>
			Online Exclusive<br>
			$15<br>
			<button onclick="addToBag()" class="add-bag">Add to Bag </button></p>
		</div>
		<div class="item">
		<img src="Photos/Shoes/sandals/sandal2.jpg" class="sale"/>
		<p><b>White Vintage</b><br>
			Online Exclusive<br>
			$15<br>
			<button onclick="addToBag()" class="add-bag">Add to Bag </button></p>
		</div>
		<div class="item">
		<img src="Photos/Shoes/sandals/sandal3.jpg" class="sale"/>
		<p><b>Black Professional</b><br>
			Online Exclusive<br>
			$15<br>
			<button onclick="addToBag()" class="add-bag">Add to Bag </button></p>
		</div>
		<div class="item">
		<img src="Photos/Shoes/sandals/sandal4.jpg" class="sale"/>
		<p><b>Colorful Spark</b><br>
			Online Exclusive<br>
			$15<br>
			<button onclick="addToBag()" class="add-bag">Add to Bag </button></p>
		</div>
		<div class="item">
		<img src="Photos/Shoes/sandals/sandal5.jpg" class="sale"/>
		<p><b>Mexican Vintage</b><br>
			Online Exclusive<br>
			$15<br>
			<button onclick="addToBag()" class="add-bag">Add to Bag </button></p>
		</div>
		<div class="item">
		<img src="Photos/Shoes/sandals/sandal6.jpg" class="sale"/>
		<p><b>Simple Green</b><br>
			Online Exclusive<br>
			$15<br>
			<button onclick="addToBag()" class="add-bag">Add to Bag </button></p>
		</div>
		<div class="item">
		<img src="Photos/Shoes/sandals/sandal7.jpg" class="sale"/>
		<p><b>White Modern</b><br>
			Online Exclusive<br>
			$15<br>
			<button onclick="addToBag()" class="add-bag">Add to Bag </button></p>
		</div>
		<div class="item">
		<img src="Photos/Shoes/sandals/sandal8.jpg" class="sale"/>
		<p><b>Yellow Beach</b><br>
			Online Exclusive<br>
			$15<br>
			<button onclick="addToBag()" class="add-bag">Add to Bag </button></p>
		</div>
		<div class="item">
		<img src="Photos/Shoes/sandals/sandal9.jpg" class="sale"/>
		<p><b>White Hole</b><br>
			Online Exclusive<br>
			$15<br>
			<button onclick="addToBag()" class="add-bag">Add to Bag </button></p>
		...
		<div class="item">
		<img src="Photos/Shoes/sandals/sandal10.jpg" class="sale"/>
		<p><b>Pink Classic</b><br>
			Online Exclusive<br>
			$15<br>
			<button onclick="addToBag()" class="add-bag">Add to Bag </button></p>
		</div>
		<div class="item">
		<img src="Photos/Shoes/sandals/sandal11.jpg" class="sale"/>
		<p><b>Brown Modern</b><br>
			Online Exclusive<br>
			$15<br>
			<button onclick="addToBag()" class="add-bag">Add to Bag </button></p>
		</div>
		<div class="item">
		<img src="Photos/Shoes/sandals/sandal12.jpg" class="sale"/>
		<p><b>Beach Ready</b><br>
			Online Exclusive<br>
			$15<br>
			<button onclick="addToBag()" class="add-bag">Add to Bag </button></p>
		</div>
