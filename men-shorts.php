...
<body onload="startTimer()">
	<div id="wrapper">
		...
		<h2> Men's Shorts</h2>
		<div class="item">
		<img src="Photos/Men/shorts/short1.jpg" class="sale"/>
		<p><b>White Resort</b><br>
			Online Exclusive<br>
			$15<br>
			<button onclick="addToBag()" class="add-bag">Add to Bag </button></p>
		</div>
		<div class="item">
		<img src="Photos/Men/shorts/short2.jpg" class="sale"/>
		<p><b>Demin Sublevel</b><br>
			Online Exclusive<br>
			$15<br>
			<button onclick="addToBag()" class="add-bag">Add to Bag </button></p>
		</div>
		<div class="item">
		<img src="Photos/Men/shorts/short3.jpg" class="sale"/>
		<p><b>YE Shorts</b><br>
			Online Exclusive<br>
			$15<br>
			<button onclick="addToBag()" class="add-bag">Add to Bag </button></p>
		...
		<div class="item">
		<img src="Photos/Men/shorts/short4.jpg" class="sale"/>
		<p><b>MUD Shorts</b><br>
			Online Exclusive<br>
			$15<br>
			<button onclick="addToBag()" class="add-bag">Add to Bag </button></p>
		...
		<div class="item">
		<img src="Photos/Men/shorts/short5.jpg" class="sale"/>
		<p><b>Shorts</b><br>
			Online Exclusive<br>
			$15<br>
			<button onclick="addToBag()" class="add-bag">Add to Bag </button></p>
		...
		<div class="item">
		<img src="Photos/Men/shorts/short6.jpg" class="sale"/>
		<p><b>Scott Vintage</b><br>
			Online Exclusive<br>
			$15<br>
			<button onclick="addToBag()" class="add-bag">Add to Bag </button></p>
		</div>
		<div class="item">
		<img src="Photos/Men/shorts/short7.jpg" class="sale"/>
		<p><b>Capital</b><br>
			Online Exclusive<br>
			$15<br>
			<button onclick="addToBag()" class="add-bag">Add to Bag </button></p>
		...
		<div class="item">
		<img src="Photos/Men/shorts/short8.png" class="sale"/>
		<p><b>Bjorn Borg</b><br>
			Online Exclusive<br>
			$15<br>
			<button onclick="addToBag()" class="add-bag">Add to Bag </button></p>
		...
		<div class="item">
		<img src="Photos/Men/shorts/short9.jpg" class="sale"/>
		<p><b>Vintage Shorts</b><br>
			Online Exclusive<br>
			$15<br>
			<button onclick="addToBag()" class="add-bag">Add to Bag </button></p>
		</div>
		<div class="item">
		<img src="Photos/Men/shorts/short10.jpg" class="sale"/>
		<p><b>Retro Shorts</b><br>
			Online Exclusive<br>
			$15<br>
			<button onclick="addToBag()" class="add-bag">Add to Bag </button></p>
		</div>
		<div class="item">
		<img src="Photos/Men/shorts/short11.jpg" class="sale"/>
		<p><b>Unusual Super Dry</b><br>
			Online Exclusive<br>
			$15<br>
			<button onclick="addToBag()" class="add-bag">Add to Bag </button></p>
		</div>
		<div class="item">
		<img src="Photos/Men/shorts/short12.jpg" class="sale"/>
		<p><b>Hollister UK</b><br>
			Online Exclusive<br>
			$15<br>
			<button onclick="addToBag()" class="add-bag">Add to Bag </button></p>
		</div>
