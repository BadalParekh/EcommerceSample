...
<body onload="startTimer()">
	<div id="wrapper">
		...
		<h2> Heels</h2>
		<div class="item">
		<img src="Photos/Shoes/heels/heel1.jpg" class="sale"/>
		<p><b>Kitten Heels</b><br>
			Online Exclusive<br>
			$45<br>
			<button onclick="addToBag()" class="add-bag">Add to Bag </button></p>
		</div>
		<div class="item">
		<img src="Photos/Shoes/heels/heel2.jpg" class="sale"/>
		<p><b>Blur Heels</b><br>
			Online Exclusive<br>
			$45<br>
			<button onclick="addToBag()" class="add-bag">Add to Bag </button></p>
		...
		<div class="item">
		<img src="Photos/Shoes/heels/heel3.jpg" class="sale"/>
		<p><b>Oxford Heels</b><br>
			Online Exclusive<br>
			$45<br>
			<button onclick="addToBag()" class="add-bag">Add to Bag </button></p>
		</div>
		<div class="item">
		<img src="Photos/Shoes/heels/heel4.jpg" class="sale"/>
		<p><b>Brown Heels</b><br>
			Online Exclusive<br>
			$45<br>
			<button onclick="addToBag()" class="add-bag">Add to Bag </button></p>
		</div>
		<div class="item">
		<img src="Photos/Shoes/heels/heel5.jpg" class="sale"/>
		...
		<div class="item">
		<img src="Photos/Shoes/heels/heel6.jpg" class="sale"/>
		<p><b>Red Bottoms</b><br>
			Online Exclusive<br>
			$45<br>
			<button onclick="addToBag()" class="add-bag">Add to Bag </button></p>
		</div>
		<div class="item">
		<img src="Photos/Shoes/heels/heel7.jpg" class="sale"/>
		<p><b>Wedges</b><br>
			Online Exclusive<br>
			$45<br>
			<button onclick="addToBag()" class="add-bag">Add to Bag </button></p>
		...
		<div class="item">
		<img src="Photos/Shoes/heels/heel8.jpg" class="sale"/>
		<p><b>White Beach</b><br>
			Online Exclusive<br>
			$45<br>
			<button onclick="addToBag()" class="add-bag">Add to Bag </button></p>
		</div>
		<div class="item">
		<img src="Photos/Shoes/heels/heel9.jpg" class="sale"/>
		<p><b>Blue Cotton</b><br>
			Online Exclusive<br>
			$45<br>
			<button onclick="addToBag()" class="add-bag">Add to Bag </button></p>
		</div>
		<div class="item">
		<img src="Photos/Shoes/heels/heel10.jpg" class="sale"/>
		<p><b>Brown Classic</b><br>
			Online Exclusive<br>
			$45<br>
			<button onclick="addToBag()" class="add-bag">Add to Bag </button></p>
		</div>
		<div class="item">
		<img src="Photos/Shoes/heels/heel11.jpg" class="sale"/>
		...
		<div class="item">
		<img src="Photos/Shoes/heels/heel12.jpg" class="sale"/>
		<p><b>Wedding Ready</b><br>
			Online Exclusive<br>
			$45<br>
			<button onclick="addToBag()" class="add-bag">Add to Bag </button></p>
		</div>
