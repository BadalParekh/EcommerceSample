...
<body onload="startTimer()">
	<div id="wrapper">
		...
		<h2> Boots</h2>
		<div class="item">
		<img src="Photos/Shoes/boots/boot1.jpg" class="sale"/>
		<p><b>Dirty Round</b><br>
			Online Exclusive<br>
			$60<br>
			<button onclick="addToBag()" class="add-bag">Add to Bag </button></p>
		</div>
		<div class="item">
		<img src="Photos/Shoes/boots/boot2.jpg" class="sale"/>
		<p><b>Military Boots</b><br>
			Online Exclusive<br>
			$60<br>
			<button onclick="addToBag()" class="add-bag">Add to Bag </button></p>
		</div>
		<div class="item">
		<img src="Photos/Shoes/boots/boot3.jpg" class="sale"/>
		<p><b>Snow Boots</b><br>
			Online Exclusive<br>
			$60<br>
			<button onclick="addToBag()" class="add-bag">Add to Bag </button></p>
		...
		<div class="item">
		<img src="Photos/Shoes/boots/boot4.jpg" class="sale"/>
		<p><b>Black Magic</b><br>
			Online Exclusive<br>
			$60<br>
			<button onclick="addToBag()" class="add-bag">Add to Bag </button></p>
		</div>
		<div class="item">
		<img src="Photos/Shoes/boots/boot5.jpg" class="sale"/>
		<p><b>Playful Nin</b><br>
			Online Exclusive<br>
			$60<br>
			<button onclick="addToBag()" class="add-bag">Add to Bag </button></p>
		</div>
		<div class="item">
		<img src="Photos/Shoes/boots/boot6.jpg" class="sale"/>
		<p><b>Adventure Time</b><br>
			Online Exclusive<br>
			$60<br>
			<button onclick="addToBag()" class="add-bag">Add to Bag </button></p>
		</div>
		<div class="item">
		<img src="Photos/Shoes/boots/boot7.jpg" class="sale"/>
		<p><b>Dance Time</b><br>
			Online Exclusive<br>
			$60<br>
			<button onclick="addToBag()" class="add-bag">Add to Bag </button></p>
		...
		<div class="item">
		<img src="Photos/Shoes/boots/boot8.jpg" class="sale"/>
		<p><b>Work Boots</b><br>
			Online Exclusive<br>
			$60<br>
			<button onclick="addToBag()" class="add-bag">Add to Bag </button></p>
		...
		<div class="item">
		<img src="Photos/Shoes/boots/boot9.jpg" class="sale"/>
		<p><b>Green Caca</b><br>
			Online Exclusive<br>
			$60<br>
			<button onclick="addToBag()" class="add-bag">Add to Bag </button></p>
		...
		<div class="item">
		<img src="Photos/Shoes/boots/boot10.jpg" class="sale"/>
		<p><b>Brown Sassy</b><br>
			Online Exclusive<br>
			$60<br>
			<button onclick="addToBag()" class="add-bag">Add to Bag </button></p>
		</div>
		<div class="item">
		<img src="Photos/Shoes/boots/boot11.jpg" class="sale"/>
		<p><b>Dirt Gal</b><br>
			Online Exclusive<br>
			$60<br>
			<button onclick="addToBag()" class="add-bag">Add to Bag </button></p>
		...
		<div class="item">
		<img src="Photos/Shoes/boots/boot12.jpg" class="sale"/>
		<p><b>Clean Train</b><br>
			Online Exclusive<br>
			$60<br>
			<button onclick="addToBag()" class="add-bag">Add to Bag </button></p>
		</div>
