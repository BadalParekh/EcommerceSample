...
<body onload="startTimer()">
	<div id="wrapper">
		...
		<h2> Men's Polos</h2>
		<div class="item">
		<img src="Photos/Men/polos/polo1.jpg" class="sale"/>
		...
		<div class="item">
		<img src="Photos/Men/polos/polo2.jpg" class="sale"/>
		<p><b>Country Standard</b><br>
			Online Exclusive<br>
			$65<br>
			<button onclick="addToBag()" class="add-bag">Add to Bag </button></p>
		</div>
		<div class="item">
		<img src="Photos/Men/polos/polo3.jpg" class="sale"/>
		<p><b>Hot Pink</b><br>
			Online Exclusive<br>
			$65<br>
			<button onclick="addToBag()" class="add-bag">Add to Bag </button></p>
		...
		<div class="item">
		<img src="Photos/Men/polos/polo4.jpg" class="sale"/>
		<p><b>70s Blue</b><br>
			Online Exclusive<br>
			$65<br>
			<button onclick="addToBag()" class="add-bag">Add to Bag </button></p>
		...
		<div class="item">
		<img src="Photos/Men/polos/polo5.jpg" class="sale"/>
		<p><b>Paint Splash</b><br>
			Online Exclusive<br>
			$65<br>
			<button onclick="addToBag()" class="add-bag">Add to Bag </button></p>
		</div>
		<div class="item">
		<img src="Photos/Men/polos/polo6.jpg" class="sale"/>
		<p><b>Futuristic</b><br>
			Online Exclusive<br>
			$65<br>
			<button onclick="addToBag()" class="add-bag">Add to Bag </button></p>
		...
		<div class="item">
		<img src="Photos/Men/polos/polo7.jpg" class="sale"/>
		<p><b>Capital</b><br>
			Online Exclusive<br>
			$65<br>
			<button onclick="addToBag()" class="add-bag">Add to Bag </button></p>
		...
		<div class="item">
		<img src="Photos/Men/polos/polo8.jpg" class="sale"/>
		<p><b>USA</b><br>
			Online Exclusive<br>
			$65<br>
			<button onclick="addToBag()" class="add-bag">Add to Bag </button></p>
		...
		<div class="item">
		<img src="Photos/Men/polos/polo9.jpg" class="sale"/>
		<p><b>Rooster</b><br>
			Online Exclusive<br>
			$65<br>
			<button onclick="addToBag()" class="add-bag">Add to Bag </button></p>
		...
		<div class="item">
		<img src="Photos/Men/polos/polo10.jpg" class="sale"/>
		<p><b>Lucky Dog</b><br>
			Online Exclusive<br>
			$65<br>
			<button onclick="addToBag()" class="add-bag">Add to Bag </button></p>
		...
		<div class="item">
		<img src="Photos/Men/polos/polo11.jpg" class="sale"/>
		<p><b>Big Evil</b><br>
			Online Exclusive<br>
			$65<br>
			<button onclick="addToBag()" class="add-bag">Add to Bag </button></p>
		...
		<div class="item">
		<img src="Photos/Men/polos/polo12.jpg" class="sale"/>
		<p><b>Striped</b><br>
			Online Exclusive<br>
			$65<br>
			<button onclick="addToBag()" class="add-bag">Add to Bag </button></p>
